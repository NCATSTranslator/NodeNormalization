...
- NodeNorm: [v2.3.15](https://github.com/NCATSTranslator/NodeNormalization/releases/tag/v2.3.15)
...
## New features
* Update Biolink model by replacing bmt-lite with bmt ([#282](https://github.com/NCATSTranslator/NodeNormalization/pull/282),
  [#284](https://github.com/NCATSTranslator/NodeNormalization/pull/284))
* Added /get_setid GET endpoint need for Multi-CURIE Query (MCQ)  ([#274](https://github.com/NCATSTranslator/NodeNormalization/pull/274))
...
* [NodeNorm v2.3.12](https://github.com/NCATSTranslator/NodeNormalization/releases/tag/v2.3.12)
  * Rename redis_connection[0-6] to their database names by @gaurav in #271
* [NodeNorm v2.3.13](https://github.com/NCATSTranslator/NodeNormalization/releases/tag/v2.3.13): Incremented version,
  which I forgot to do in the previous release.
* [NodeNorm v2.3.14](https://github.com/NCATSTranslator/NodeNormalization/releases/tag/v2.3.14)
