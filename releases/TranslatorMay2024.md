...
- NodeNorm: [v2.3.11](https://github.com/NCATSTranslator/NodeNormalization/releases/tag/v2.3.11)
...
* [NodeNorm v2.3.6](https://github.com/NCATSTranslator/NodeNormalization/releases/tag/v2.3.6)
  * Reverted NodeNorm loader to Redis v6
* [NodeNorm v2.3.7](https://github.com/NCATSTranslator/NodeNormalization/releases/tag/v2.3.7)
  * Added Translator release information
  * Fixed examples
* [NodeNorm v2.3.8](https://github.com/NCATSTranslator/NodeNormalization/releases/tag/v2.3.8): Forgot to increment the
  version in the previous release.
* [NodeNorm v2.3.9](https://github.com/NCATSTranslator/NodeNormalization/releases/tag/v2.3.9)
...
* [NodeNorm v2.3.10](https://github.com/NCATSTranslator/NodeNormalization/releases/tag/v2.3.10)
